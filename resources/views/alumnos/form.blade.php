                ...
                <form action="{{url('/alumnos')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="text" class="form-control" name="FirstName" id="FirstName" value="{{ $alumnos->FirstName}}"  required>
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="text" class="form-control" name="SecondName" id="SecondName" value="{{ $alumnos->SecondName}}" required>
                            <div class="invalid-feedback">
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control" name=LastName id="LastName" value="{{ $alumnos->LastName}}" required>
                            <div class="invalid-feedback">
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control" name=DateOfBirth id="DateOfBirth" value="{{ $alumnos->DateOfBirth}}" required>
                            <div class="invalid-feedback">
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control" name=Address id="Address"value="{{ $alumnos->Address}}" required>
                            <div class="invalid-feedback">
                        ...
                        <div class="col-12">
                            ...
                            <input type="email" class="form-control" name="Email" id="Email" value="{{ $alumnos->Email}}" placeholder="you@example.com">
                            <div class="invalid-feedback">
                        ...
                        <div class="col-6">
                            ...
                            <input type="text" class="form-control" name="Dpi" id="Dpi" value="{{ $alumnos->Dpi}}" required>
                            <div class="invalid-feedback">
                        ...
                        <div class="col-6">
                            ...
                            <input type="text" class="form-control" name="Cel" id="Cel" value="{{ $alumnos->Cel}}" required>
                            <div class="invalid-feedback">
